  ...
  return (
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === "ios" ? 'padding' : "height"}
      ...
      <ScrollView style={{ width: "100%" }} contentContainerStyle={styles.scroll}>
        <Spacer />
        <CustomInput value={username} setValue={setUsername} labelText="Username:" infoText="you can change this later" showInfoTextOnFocus />
        <Spacer size="small" />
        <CustomInput value={fullname} setValue={setFullname} labelText="Fullname (optional):" infoText="helps your friends find you" showInfoTextOnFocus />
        <Spacer />
      </ScrollView>
